...
Once you have connected to the Azure Blob data source, follow these steps to create queries and interact with an Azure Blob storage from the ToolJet application:
